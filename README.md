...
As shown below, some original annotations (masks) might need modification using the prediction results of the tiled inference of this segmentation model. Probably the modified mask may be generated by
a <b>bitwise_and</b> operation between the original mask and tiled inferred mask.<br> 
<table>
<tr>
<th>Input: image</th>
