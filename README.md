...
As shown below, some original annotations (masks) might need modification using the prediction results of the tiled inference of the this segmentation model. Probably the new masks may be generated by
the <b>bitwise_and</b> operations between the original masks and tiled-inferred-masks.<br> 
<table>
<tr>
<th>Input: image</th>
